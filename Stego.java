...
class Stego {
  ...
  public void encode(){
    ...
    System.out.println("Hiding the ciphertext in wave file ...");
	...
	System.out.println("Steganographed wave file is written as " + outFile +"...");
	} catch(Exception e) {
  ...
  public boolean decode(){
    ...
    int length = 0;
    int k = 1;
    System.out.println("Retrieving the ciphertext from wave file ....");
  ...
  private void readSND(String sndf) {
    ...
    System.out.println("Reading WAVE sound file ...");
    try {
